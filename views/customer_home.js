...
import addimg from '../assets/images/btn_add_circle.png';
		...
		return (
            <View style={{height:'100%', alignItems:'center'}}>
                ...
                <LinearGradient colors = {[GlobalColors.colorMainBackTop, GlobalColors.colorMainBackMiddle, GlobalColors.colorMainBackBottom]} 
                    ...
                    <TouchableOpacity style = {styles.transaction} onPress={() => this.props.navigation.navigate('TranHistory') }>
                 ...
                 <TouchableOpacity style={{width:80, height:80, marginTop:-90, borderRadius:40 }} onPress={() => this.props.navigation.navigate('customer_get_qr') }>
                        <Image  source={addimg} style={{zIndex:10}}></Image>
                </TouchableOpacity>
                <TouchableOpacity style={{marginTop: 20, marginLeft:10 }} onPress={() => this.props.navigation.navigate('customer_topup')}>
