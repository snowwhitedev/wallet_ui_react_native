...
import bankimg from '../assets/images/bank_logo1.png';

export default class Merchant_Withdraw_Success extends Component {
            ...
            <View style={{height:'100%', alignItems:'center'}}>
                ...
                <LinearGradient colors = {[GlobalColors.colorMainBackTop, GlobalColors.colorMainBackMiddle, GlobalColors.colorMainBackBottom]} 
                    ...
                    <View style={{marginTop:20}}>
                        <Text style={styles.noteText}>Withdrawal Successful!</Text>
                    </View>
                    <View style={styles.trans_list}>
                        ...
                        <View style={styles.trans_item}>
                            ...
                            <View style={{flexGrow:1}}></View>
                            <Text style={styles.item_res}>$2,549.30</Text>                                
                        </View>
                        <View style={styles.trans_item}>
                            <Text style={styles.item_name}>Paying Used</Text>
                            <View style={{flexGrow:1}}></View>
                            <View>
                                <View style={{flexDirection:'row'}}>
                                    <Image style={styles.item_image} source={bankimg}></Image>
                                    <Text style={styles.item_res}>MasterCard</Text>
                                </View>
                                <Text style={styles.item_res_sub}>Bank Account</Text>
                            </View>
                        </View>
